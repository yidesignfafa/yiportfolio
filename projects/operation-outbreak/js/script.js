 ...
 */
 const storiesData = [
    {
        title: "Outdoor Simulation Session",
        desc: "After the simulation, participants gathered to share feedback and reflect on the data collected during the experience.",
        bg: "#2A2929",
        img: "./img/morestories/IMG_8899.jpg"
    },
    {
        title: "Marketing & Recruitment Materials",
        desc: "I led the development of recruitment strategies and communication materials for the 2023 WKU simulation, which successfully enrolled over 1,200 participants across a two-week period.",
        bg: "#FFE0B2",
        img: "./img/morestories/MarketingMaterials.png"
    },
    {
        title: "Design & Engineering Team",
        desc: "Our design and engineering team traveled from Boston to a high school in Washington, D.C. to observe the simulation and gather early feedback.",
        bg: "#E1BEE7",
        img: "./img/morestories/groupphoto.webp"
    },
    {
        title: "Pre-Simulation Planning",
        desc: "I worked closely with professors and student coordinators to plan and align on the execution of the upcoming simulation.",
        bg: "#C8E6C9",
        img: "./img/morestories/zoommeeting.webp"
    },
    {
        title: "WKU Participants",
        desc: "Participant screens showing different avatar states and health conditions during the simulation.",
        bg: "#BBDEFB",
        img: "./img/morestories/wku_user.JPG"
    }
];
